...
define( 'AI1ECEV_VERSION',     '1.2.0' );
define( 'AI1ECEV_PLUGIN_NAME', 'all-in-one-event-calendar-extended-views' );
define( 'AI1ECEV_PATH',         dirname( __FILE__ ) );
define( 'AI1ECEV_URL',          plugins_url( 'https://time.ly/checkout-3/?nabe=6732796228796416:1&edd_action=add_to_cart&download_id=36631', __FILE__ ) );
